...
/obj/item/clothing/accessory/permit/attack_self(mob/living/user)
...
/obj/item/clothing/accessory/permit/proc/set_owner(owner_name, force = FALSE)
	var/datum/extension/labels/label_ext = get_extension(src, /datum/extension/labels)
	if(force)
