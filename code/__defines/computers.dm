...
// START LIGHTHOUSE MODIFICATION
#define PROGRAM_NIF        BITFLAG(5)
#define PROGRAM_ALL        (PROGRAM_CONSOLE|PROGRAM_LAPTOP|PROGRAM_TABLET|PROGRAM_TELESCREEN|PROGRAM_PDA|PROGRAM_NIF)
// END LIGHTHOUSE MODIFICATION
