...
/decl/chemical_reaction/recipe/beerbatter
	...
	required_reagents = list(/decl/material/liquid/nutriment/batter = 1, /decl/material/liquid/ethanol/beer = 1)
	result_amount = 2
	mix_message = "The beer darkens the batter and makes it fizz."
