...
function run_code_tests {
    ...
    run_test_fail "maps contain no cable dir setting" "grep '\bd[12] = ' maps/**/*.dmm"
    run_test_fail "maps contain no layer adjustments" "grep '\blayer = ' maps/**/*.dmm"
    run_test_fail "maps contain no plane adjustments" "grep '\bplane = ' maps/**/*.dmm"
