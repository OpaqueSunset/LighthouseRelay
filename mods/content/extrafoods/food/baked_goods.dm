...
/obj/item/food/quicheslice/filled/Initialize()
	. = ..()
	add_to_reagents(/decl/material/solid/organic/meat, 1)

/obj/item/food/sliceable/brownies
	name = "brownies"
	gender = PLURAL
	desc = "Halfway to fudge, or halfway to cake? Who cares!"
	icon = 'mods/content/extrafoods/icons/obj/food.dmi'
	icon_state = "brownies"
	slice_path = /obj/item/food/browniesslice
	slice_num = 4
...
/obj/item/food/sliceable/brownies/Initialize()
	. = ..()
	add_to_reagents(/decl/material/liquid/nutriment/browniemix, 2)

/obj/item/food/browniesslice
	name = "brownie"
...
/obj/item/food/sliceable/cosmicbrownies/Initialize()
	. = ..()
	add_to_reagents(/decl/material/liquid/nutriment/browniemix, 2)
...
/obj/item/food/cosmicbrowniesslice
	name = "cosmic brownie"
...
/obj/item/food/cosmicbrowniesslice/filled
	nutriment_amt = 1

/obj/item/food/cosmicbrowniesslice/filled/Initialize()
	. = ..()
	add_to_reagents(/decl/material/liquid/nutriment/browniemix, 1)
...
/obj/item/food/honeybun/Initialize()
	. = ..()
	add_to_reagents(/decl/material/liquid/nutriment/honey, 2)

/obj/item/food/cinnamonbun
	name = "cinnamon bun"
